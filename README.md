...
- **dataset/** – Dataset configuration used for training.
- **project_results/figures/** – Training curves, confusion matrices, and evaluation plots.
- **project_results/predictions/** – Sample detection results generated by the trained model.
- **notebooks/** – Google Colab notebook used during development.

## Model Performance

The custom YOLOv8 Nano model was trained for **30 epochs** on a custom road damage dataset containing three object classes:
...
The model achieved its strongest performance on pothole detection, while crack and manhole detection remain more challenging due to greater visual variability and class imbalance.
